    ...
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form action="index.php?action=register" method="POST" class="space-y-6">
            <div>
                ...
                <input id="nama_lengkap" name="nama_lengkap" type="text" required class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div>
        ...
        <p class="text-sm text-center text-gray-600">
            Sudah punya akun? <a href="index.php?page=login" class="font-medium text-indigo-600 hover:text-indigo-500">Login di sini</a>
        </p>
    </div>
</div>
